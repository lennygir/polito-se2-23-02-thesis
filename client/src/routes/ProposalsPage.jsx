  ...
  const filterProposals = (filterValues = {}) => {
    let filteredProposals = proposals.filter((p) => {
      return (
        ...
        (p.supervisor && p.supervisor.toLowerCase().includes(searchValue.toLowerCase())) ||
        (p.required_knowledge && p.required_knowledge.toLowerCase().includes(searchValue.toLowerCase())) ||
        (p.keywords && p.keywords.toLowerCase().includes(searchValue.toLowerCase()))
      );
    });
